<form>
	...
	<div class="stepTwo">
		<div class="form-group">
			...
			<span class="signup-error firstname-error"></span>
		</div>
		<div class="form-group">
			<input type="text" class="form-control" name="name" placeholder="Enter your name">
			<span class="signup-error name-error"></span>
		</div>
		<div class="form-group">
			<select name="timezone" size="1" data-placeholder="Select time zone">
				<option value=""></option>
		...
		<div class="form-group">
			<center><button class="btn btn-primary btn-lg">Sign up</button></center>
		</div>
	</div>
	<div class="form-group">
